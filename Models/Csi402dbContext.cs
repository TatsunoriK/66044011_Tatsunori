...
public partial class Csi402dbContext : DbContext
{
    ...
    public Csi402dbContext(DbContextOptions<Csi402dbContext> options) : base(options) { }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql("server=localhost;port=3306;database=csi402db;user=root;password=Nori_kato43016",
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Orderdetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.Orderdetails).HasForeignKey(d => d.OrderId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("orderdetails_ibfk_1");
            entity.HasOne(d => d.PidNavigation).WithMany(p => p.Orderdetails).HasForeignKey(d => d.Pid).HasConstraintName("orderdetails_ibfk_2");
        });
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(e => e.Pname).HasMaxLength(200).HasColumnName("PName");
            entity.Property(e => e.Price).HasPrecision(10, 2);
            entity.Property(e => e.ImagePath).HasMaxLength(255);
            entity.HasOne(d => d.Brand).WithMany(p => p.Products).HasForeignKey(d => d.BrandId).HasConstraintName("products_ibfk_2");
            entity.HasOne(d => d.Cat).WithMany(p => p.Products).HasForeignKey(d => d.CatId).HasConstraintName("products_ibfk_1");
        });
        ...
        modelBuilder.Entity<Productstock>(entity =>
        {
            ...
            entity.Property(e => e.LastUpdate).ValueGeneratedOnAddOrUpdate().HasDefaultValueSql("CURRENT_TIMESTAMP").HasColumnType("timestamp");
            entity.Property(e => e.Quantity).HasDefaultValueSql("'0'");
            entity.HasOne(d => d.PidNavigation).WithOne(p => p.Productstock).HasForeignKey<Productstock>(d => d.Pid).HasConstraintName("productstock_ibfk_1");
        });
        ...
        modelBuilder.Entity<Userprofile>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithOne(p => p.Userprofile).HasForeignKey<Userprofile>(d => d.UserId).HasConstraintName("userprofiles_ibfk_1");
        });
        ...
        modelBuilder.Entity<LabStudent>(entity =>
        {
            ...
            entity.Property(e => e.StdID).HasMaxLength(10).IsRequired();
        ...
        modelBuilder.Entity<Stockhistory>(entity =>
        {
            ...
            entity.HasOne(d => d.PidNavigation).WithMany().HasForeignKey(d => d.Pid);
        });
        ...
        modelBuilder.Entity<Couponusage>(entity =>
        {
            ...
            entity.Property(e => e.UsedAt).HasDefaultValueSql("CURRENT_TIMESTAMP").HasColumnType("datetime");
            entity.HasOne(d => d.Coupon).WithMany(p => p.Couponusages).HasForeignKey(d => d.CouponId);
            entity.HasOne(d => d.User).WithMany(p => p.Couponusages).HasForeignKey(d => d.UserId);
            entity.HasOne(d => d.Order).WithMany(p => p.Couponusages).HasForeignKey(d => d.OrderId);
        });
        ...
        modelBuilder.Entity<Pointhistory>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP").HasColumnType("datetime");
            entity.HasOne(d => d.User).WithMany(p => p.Pointhistories).HasForeignKey(d => d.UserId);
            entity.HasOne(d => d.Order).WithMany(p => p.Pointhistories).HasForeignKey(d => d.OrderId);
        });
